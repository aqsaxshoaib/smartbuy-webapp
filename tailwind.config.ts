  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        // dark
        'dark-tremor-input': '0 1px 2px 0 rgba(0, 0, 0, 0.05)',
        'dark-tremor-card': '0 1px 3px 0 rgba(0, 0, 0, 0.1), 0 1px 2px -1px rgba(0, 0, 0, 0.1)',
        'dark-tremor-dropdown': '0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -2px rgba(0, 0, 0, 0.1)',
      },
      maxWidth: {
        "10xl": '1440px'
      },
